...
class Generator(nn.Module):
    ...
    def __init__(self, noise_dim=1024, depth1=5, depth2=4, depth3=4, initial_size=8, dim=384, heads=4, mlp_ratio=4,
...
class Discriminator(nn.Module):
    def __init__(self, image_size=32, patch_size=4, input_channel=3, num_classes=10,
